...
R_S2 = computeStaticCalibration(Q_S2_static);
R_LT = computeStaticCalibration(Q_LT_static);
R_RT = computeStaticCalibration(Q_RT_static);
...
Rpelvis = computeSegmentOrientation(Q_S2_mov, R_S2);   % 3x3xN
RLthigh = computeSegmentOrientation(Q_LT_mov, R_LT);
RRthigh = computeSegmentOrientation(Q_RT_mov, R_RT);
